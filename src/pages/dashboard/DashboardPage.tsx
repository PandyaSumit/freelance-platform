...
// Role-specific greetings - MVP: 2 roles only
            ...
            >
              <CardContent sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                ...
                <Box>
                  ...
                  <Typography variant="caption" color="text.secondary">Start a new client project</Typography>
                </Box>
            ...
            >
              <CardContent sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                ...
                <Box>
                  ...
                  <Typography variant="caption" color="text.secondary">Add a new client</Typography>
                </Box>
                <ArrowForward sx={{ ml: 'auto', color: 'text.secondary' }} />
              </CardContent>
            </Card>
            ...
            >
              <CardContent sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                ...
                <Box>
                  ...
                  <Typography variant="caption" color="text.secondary">Bill your clients</Typography>
                </Box>
                <ArrowForward sx={{ ml: 'auto', color: 'text.secondary' }} />
              </CardContent>
            </Card>
